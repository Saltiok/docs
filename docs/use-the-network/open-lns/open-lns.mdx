...
Helium Open LNS is the infrastructure that allows network operators to use any LoRaWAN Network 
Server ("LNS") for to connect wireless devices on the Helium Network.

Open LNS marks a significant shift in the way that the LoRaWAN protocol is managed, most easily 
summarized by simplicity, scale, and speed.
